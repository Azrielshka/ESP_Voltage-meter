...
Устройство измеряет напряжение на аккумуляторе, преобразует в процент заряда и отправляет на сервер MQTT, используя сеть WiFi. Мониторинг можно производить в приложении GyverHub (доступно AppStore, GooglePlay)
...
* Сделано в модульном варианте. Компоненты ESP_Voltage-meter:
	* 1. Датчик тока INA
...
width=45% height=45%>
<img src="https://github.com/user-attachments/assets/72e29704-615c-45c5-9fc4-f51f6ff9354b" 
width=45% height=45%>
